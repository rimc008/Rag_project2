...
export default function Heropage({setQuizQuestions1,documentid,setDocumentid,document,setDocument,documentname,setDocumentname,chatHistory,setChatHistory,colorset,setColorset}) {
        ...
        <div className="flex items-center gap-4">
          ...
          <Button 
            ...
            className={`flex items-center gap-2 rounded-xl transition-all cursor-pointer ${
              darkMode 
                ? `border-zinc-800 ${(colorset === 1) ? "bg-green-300" :"bg-zinc-900"} hover:bg-zinc-800 ${(colorset === 1)?"text-black font-bold":"text-white-200 font-bold"} hover:text-white` 
                : `border-zinc-200 ${(colorset === 1) ? "bg-green-300" :"bg-white"} hover:bg-zinc-100 text-black-800 font-bold`
            }`}
          >
            <UploadCloud size={16} />
      ...
      <main className="max-w-6xl mx-auto mt-12 grid md:grid-cols-5 gap-8 px-6 pb-24">
        ...
        <section className="md:col-span-2 space-y-6 h-max">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className={`p-4 rounded-xl border ${darkMode ? "bg-zinc-900/20 border-zinc-700" : "bg-zinc-50/30 border-zinc-500"}`}>
